# Initial Build Sequence Handoff

Start with:

1. `packages/domain`
2. `packages/integration-contracts`
3. missing canonical doc completion for implementation-critical shells
4. orchestration and persistence work only after those foundations are stable
